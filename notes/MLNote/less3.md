...
>PLA能够在平面中选择一条直线将样本数据完全正确分类。而对于线性不可分的情况，可以使用Pocket Algorithm来处理。本节课将主要介绍一下机器学习有哪些种类，并进行归纳
...
![](assets/markdown-img-paste-2020031409350879.png)  
...
![](assets/markdown-img-paste-20200314093559964.png)  
...
![](assets/markdown-img-paste-20200314093711689.png)  
...
![](assets/markdown-img-paste-20200314093916736.png)  
...
![](assets/markdown-img-paste-20200314094044543.png)  

## 总结

本节课主要介绍了机器学习的类型，包括Out Space、Data Label、Protocol、Input Space四种类型。  

![](assets/markdown-img-paste-20200314094125218.png)  
